    ...
    <div class="x_panel">
        ...
        <div class="x_content">
            <div class="row">
                ...
                <div class="col-md-3">
                    <div class="form-group">
                        <label for="filter-current-step">Current Step</label>
                        <select id="filter-current-step" class="form-control">
...
@section('content-script')
    ...
    <script>
        $(document).ready(function() {
            ...
            tbldata = $("#tbl-datatable").DataTable({
                ...
                ajax: {
                    ...
                    data: function(data) {
                        ...
                        data.current_step = $('#filter-current-step').val();
                ...
                responsive: true,
                pagingType: 'simple',
                dom: `<"row"<"col-sm-6 d-flex align-items-center"lB><"col-sm-6">>tip`,
                buttons: [
                    @if ($isAdmin)
                        {
            ...
            $('#filter-status, #filter-current-step, #filter-timeoff, #filter-start-date, #filter-end-date, #filter-branch, #filter-organization, #filter-level, #filter-position')
                .on('change',
                    function() {
                        tbldata.ajax.reload();
                    });
