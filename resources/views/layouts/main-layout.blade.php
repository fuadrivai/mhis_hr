      ...
      <div class="main_container">
        <div class="col-md-3 left_col">
          <div class="left_col scroll-view">
            <div class="navbar nav_title" style="border: 0;">
              <a href="" class="site_title"><img class="img-thumbnail rounded" src="/images/logo-mh.png" width="35" alt=""> <span>Mutiara Harapan</span></a>
            </div>
            ...
            <div id="sidebar-menu" class="main_menu_side hidden-print main_menu">
              <div class="menu_section">
                <ul class="nav side-menu">
                  ...
                  <li class={{Request::is('employee*')?"active":""}}><a><i class="fa fa-users"></i> Employee Directory <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu" style="display: {{Request::is('employee*')?"block":"none"}}">
                      <li class={{Request::is('employee*')?"current-page":""}}><a href="/employee">Employee</a></li>
                    </ul>
                  </li>
        ...
        <footer>
          <div class="pull-right">
            Copyright © 2024 <a href="https://mutiaraharapan.sch.id/">Mutiara Harapan Islamic School</a>. All rights reserved.
          </div>
          <div class="clearfix"></div>
        </footer>
        <!-- /footer content -->
