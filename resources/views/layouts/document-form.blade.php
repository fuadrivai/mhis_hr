                ...
                <div class="header-content">
                    <div class="logo-container">
                        <div class="logo-wrapper">
                            <img src="https://mutiaraharapan.sch.id/wp-content/uploads/2017/01/logo-bintaro.png"
            ...
            <div class="card-body">
                ...
                <form id="memoForm" action="/internal-document" method="POST">
                    ...
                    <div class="form-group">
                        <label for="typeMemo"><i class="fa fa-tag"></i>Type <span class="text-danger">*</span></label>
                        <select name="type" id="typeMemo" class="form-control" required>
                    ...
                    <!-- Document Title -->
                    <div class="form-group">
                        <label for="title"><i class="fa fa-file-text"></i>Document Title <span
                    ...
                    <!-- Document Link -->
                    <div class="form-group">
                        <label for="link"><i class="fa fa-link"></i>Document Link <span
                                class="text-danger">*</span></label>
                        <input type="url" class="form-control" id="link" name="link"
                            placeholder="https://example.com/document" required>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <small class="form-text text-muted mt-2"><i class="fa fa-info-circle mr-1"></i>Optional:
                            Provide
                            context or special instructions for approvers.</small>
                    </div>
                ...
                ajax(formData, form.attr('action'), form.attr('method'),
                    ...
                    function(json) {
                        ...
                        const errorNotification = $(
                            '<div class="notification" style="border-left-color: #e74c3c;"><i class="fas fa-exclamation-circle text-danger"></i><div><strong>Error!</strong><br><span>Please fill in all required fields.</span></div></div>'
                        );
