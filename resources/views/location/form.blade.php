                                    ...
                                    <div class="row">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="branch_id" id="branch_id" class="form-control">
                                                    @foreach ($branches as $branch)
                                                        @if (isset($location))
                                                            <option
                                                                {{ $location->branch_id == $branch->id ? 'selected' : '' }}
                                                                value="{{ $branch->id }}">{{ $branch->name }}</option>
                                                        @else
                                                            <option {{ isset($location) }} value="{{ $branch->id }}">
                                                                {{ $branch->name }}</option>
                                                        @endif
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text"
                                                    value="{{ isset($location) ? $location->latitude : '' }}"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input type="text" id="longitude"
                                                    value="{{ isset($location) ? $location->longitude : '' }}"
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <input required type="text" id="radius"
                                                    value="{{ isset($location) ? $location->radius : '' }}"
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $('#tbl-employee').on('change', 'td input[type="checkbox"]', function() {
                ...
                if (val == true) {
                    ...
                    const index = pinLocation.employees.indexOf(employee);
                    if (index > -1) {
                        pinLocation.employees.splice(index, 1);
                    }
                }
            ...
            $("#tbl-employee-location").on('click', '.btn-delete-employee', function() {
                let data = tblUserLocation.row($(this).parents('tr')).data();
                const index = pinLocation.employees.indexOf(data);
                if (index > -1) {
                    pinLocation.employees.splice(index, 1);
                }
                reloadJsonDataTable(tblUserLocation, pinLocation.employees);
        ...
        function submitLocation() {
            ...
            ajax(pinLocation, url, method, function(json) {
                sweetAlert("Success", "Location saved successfully.", "success");
