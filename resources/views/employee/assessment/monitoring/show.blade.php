    ...
    <div class="col-md-12 col-sm-12">
        <div class="x_panel">
            <div class="x_title">
                ...
                <a href="{{ route('employee.assessment.monitoring.index') }}" class="btn btn-default btn-sm pull-right"><i class="fa fa-arrow-left"></i> Back to Monitoring</a>
                                ...
                                @foreach($groupedData as $subjectId => $data)
                                    <tr>
                                        ...
                                        <td class="align-middle text-center">
                                            <a href="{{ route('employee.assessment.monitoring.subject', ['id' => $target->id, 'subject_id' => $subjectId]) }}" class="btn btn-info btn-sm"><i class="fa fa-eye"></i> View Details</a>
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
