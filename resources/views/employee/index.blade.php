    ...
    <div class="x_panel">
        <div class="x_title">
            <ul class="nav navbar-right panel_toolbox">
                <li>
                    <a data-toggle="modal" data-target="#importExcel" href="/employee/create" class="btn btn-info btn-sm text-white btn-add-employee"><i class="fa fa-upload"></i> Import Excel</a>
                </li>
                <li>
                    <a href="/employee/create" class="btn btn-success btn-sm text-white btn-add-employee"><i class="fa fa-plus"></i> Add User</a>
                </li>
            </ul>
