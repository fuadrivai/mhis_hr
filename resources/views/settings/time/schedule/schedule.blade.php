...
<div class="x_panel">
    ...
    <div class="x_content">
      <form autocomplete="OFF" action={{isset($data)?"/schedule/".$data['id']:"/schedule"}} method="POST">
        @csrf
        @if (isset($data['id']))
        ...
        <div class="row">
          <div class="col-md-6">
            <div class="form-group">
              ...
              <input type="text" value="{{ old('effective_date',$data['effective_date']??'') }}" name="effective_date" required class="form-control has-feedback-left date-picker" id="schedule-in" placeholder="dd MMMM yyyy">
