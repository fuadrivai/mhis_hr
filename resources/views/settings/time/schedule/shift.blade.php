                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ old('schedule_out', $data['schedule_out'] ?? '') }}"
                                name="schedule_out" required class="form-control has-feedback-left time-picker"
                                id="schedule-out" placeholder="00:00">
                            <span style="top: 25px" class="fa fa-clock-o form-control-feedback left"
                                aria-hidden="true"></span>
                        </div>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" value="{{ old('break_end', $data['break_end'] ?? '') }}" id="break-end"
                                name="break_end" class="form-control has-feedback-left time-picker" placeholder="00:00">
                            <span style="top: 25px" class="fa fa-clock-o form-control-feedback left"
                                aria-hidden="true"></span>
                        </div>
                    </div>
